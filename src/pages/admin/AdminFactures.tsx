...
import { Search, CreditCard, Building, Calendar, Euro, Eye, Check } from 'lucide-react';
                        ...
                        <div className="space-y-6">
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-slate-900">{formatDate(selectedInvoice.dueDate)}</p>
                            </div>
                            {selectedInvoice.paidAt && (
                              <div>
                                <label className="text-sm font-medium text-slate-700">Payée le</label>
                                <p className="text-slate-900">{formatDate(selectedInvoice.paidAt)}</p>
                              </div>
                            )}
                          </div>
                        </div>
